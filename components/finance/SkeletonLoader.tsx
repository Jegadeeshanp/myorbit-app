...
function Bone({ className = '' }: { className?: string }) {
  return (
    <div className={`animate-pulse rounded-lg bg-gray-200 dark:bg-white/[0.07] ${className}`} />
  );
}
  ...
  return (
    <div className={`grid grid-cols-${cols} gap-3`}>
      {Array.from({ length: cols }).map((_, i) => (
        <div key={i} className="flex items-center gap-3 rounded-2xl border border-gray-100 dark:border-white/[0.07] bg-white dark:bg-gradient-to-br dark:from-[#131c2e] dark:to-[#0e1420] p-4 shadow-sm">
...
function TableRowSkeleton({ cols = 4 }: { cols?: number }) {
  return (
    <div className="flex items-center gap-4 py-3.5 border-b border-gray-100 dark:border-white/[0.04]">
      <Bone className="h-9 w-9 flex-none rounded-xl" />
...
export function AccountsSkeleton() {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-gray-100 dark:border-white/[0.07] bg-white dark:bg-gradient-to-br dark:from-[#131c2e] dark:to-[#0e1420] shadow-sm overflow-hidden">
        <div className="p-5 border-b border-gray-100 dark:border-white/[0.07]">
...
export function TransactionsSkeleton() {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-gray-100 dark:border-white/[0.07] bg-white dark:bg-gradient-to-br dark:from-[#131c2e] dark:to-[#0e1420] shadow-sm overflow-hidden">
        <div className="p-5 border-b border-gray-100 dark:border-white/[0.07] flex justify-between">
          <Bone className="h-4 w-32" />
