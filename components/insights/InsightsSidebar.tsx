    ...
    <aside className="sticky top-0 hidden h-screen w-56 flex-none flex-col overflow-y-auto border-r border-gray-100 bg-white px-3 py-5 md:flex">
      <div className="mb-5 px-2">
        <div className="flex items-center gap-2.5">
          <OrbitIcon src="/icons/dashboard-icon.png" className="h-8 w-8 rounded-lg object-cover shadow-sm" fallbackClassName="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100" fallbackContent={<Sparkles className="h-4 w-4 text-violet-600" />} />
          <div>
            <div className="text-sm font-semibold text-gray-900">Insights</div>
            <div className="text-[11px] text-gray-400">Intelligence engine</div>
          </div>
        </div>
      </div>
