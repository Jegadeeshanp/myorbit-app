...
const PAGE_TITLES: Record<string, string> = {
  '/orbit/body':          'Dashboard',
  '/orbit/body/log':      'Log Today',
  '/orbit/body/workouts': 'Workouts',
};

const PAGE_SUBTITLES: Record<string, string> = {
  '/orbit/body':          'Track your wellness metrics daily.',
  '/orbit/body/log':      'Record today\'s health data — steps, sleep, mood and more.',
  '/orbit/body/workouts': 'Your workout history and performance over time.',
};
...
export default function HealthTopBar({ action }: { action?: React.ReactNode }) {
  ...
  const title    = PAGE_TITLES[pathname] ?? 'Body';
