...
function parseCustomRepeat(v: string): ParsedCustom {
...
function CustomRepeatPicker({ initialValue, onSave, onCancel }: {
                ...
                {REPEAT_OPTS.map(o => {
                  ...
                  return (
                    <button key={o.v} type="button" onClick={() => {
                      if (o.v === 'custom') { setShowCustomRepeat(true); setShowRepeat(false); }
                      else { setRepeat(o.v); setShowRepeat(false); }
                    }}
