    ...
    <aside className="sticky top-0 hidden h-screen w-56 flex-none flex-col overflow-y-auto border-r border-gray-100 bg-white px-3 py-5 md:flex">
      <div className="mb-5 px-2">
        <div className="flex items-center gap-2.5">
          <OrbitIcon src="/icons/dashboard-icon.png" className="h-8 w-8 rounded-lg object-cover shadow-sm" fallbackClassName="flex h-8 w-8 items-center justify-center rounded-lg bg-rose-50" fallbackContent={<Heart className="h-4 w-4 text-rose-400" />} />
          <div>
