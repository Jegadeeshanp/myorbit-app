...
const PAGE_TITLES: Record<string, string> = {
  '/orbit/money':              'Overview',
  '/orbit/money/accounts':     'Accounts',
  '/orbit/money/transactions': 'Transactions',
  '/orbit/money/assets':       'Assets',
  '/orbit/money/liabilities':  'Liabilities',
  '/orbit/money/budget':       'Budget',
  '/orbit/money/insights':     'Reflect',
};

const PAGE_SUBTITLES: Record<string, string> = {
  '/orbit/money':              'Your personal money command center — manage and control finances with clarity.',
  '/orbit/money/accounts':     'Track your bank accounts, wallets, and credit cards in one place.',
  '/orbit/money/transactions': 'All income and expenses recorded in one place.',
  '/orbit/money/assets':       'Keep tabs on your investments and asset allocation.',
  '/orbit/money/liabilities':  'Keep an eye on loans, credit, and monthly obligations.',
  '/orbit/money/budget':       'Follow your monthly spending plan and stay on track.',
  '/orbit/money/insights':     'Financial insights based on your activity and trends.',
};
