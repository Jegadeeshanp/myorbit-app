...
import AssetAllocationChart from '@/components/money/AssetAllocationChart';
import SpendingCategories  from '@/components/money/SpendingCategories';
import NetWorthTrend       from '@/components/money/NetWorthTrend';
import RecentTransactions  from '@/components/money/RecentTransactions';
import TopExpenses         from '@/components/money/TopExpenses';
import SavingsRateCard     from '@/components/money/SavingsRateCard';
import BudgetStatus        from '@/components/money/BudgetStatus';
...
import { DashboardSkeleton } from '@/components/money/SkeletonLoader';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <Link href="/orbit/money/liabilities"
        ...
        <Link href="/orbit/money/accounts"
          className="flex items-center gap-3 rounded-2xl border border-emerald-100 bg-white px-5 py-4 shadow-sm transition hover:shadow-md hover:border-emerald-200 hover:-translate-y-0.5">
          <div className="flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-emerald-50">
