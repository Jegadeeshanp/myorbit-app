...
const SCORE_MODULES = [
  ...
  { key: 'health',  label: 'Body',  Icon: Heart,        iconBg: 'bg-rose-50',    iconColor: 'text-rose-600',   barColor: 'bg-rose-400' },
  { key: 'finance', label: 'Money', Icon: Wallet,       iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600',barColor: 'bg-emerald-400' },
] as const;
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {[
            ...
            { label: '+ Log Health',      href: '/orbit/body/log',   color: 'bg-rose-50 text-rose-700 hover:bg-rose-100' },
            { label: '+ Add Transaction', href: '/orbit/money',      color: 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100' },
            { label: '📊 Weekly Review',  href: '/orbit/reflect/weekly', color: 'bg-gray-50 text-gray-700 hover:bg-gray-100' },
