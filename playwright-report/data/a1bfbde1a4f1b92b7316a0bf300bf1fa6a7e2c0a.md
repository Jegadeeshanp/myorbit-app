...
- Name: finance\finance.e2e.spec.ts >> Finance overview flows (E2E) >> FIN-E2E-04 recent activity loads
- Location: tests\finance\finance.e2e.spec.ts:45:7
...
Call log:
  - navigating to "http://127.0.0.1:3000/orbit/finance", waiting until "networkidle"
